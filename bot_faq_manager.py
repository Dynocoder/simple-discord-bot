...
Saurav Prashar, 000903720, 09-17-2024
"""
import discord
from BotDataManager import BotDataManager
...
class MyClient(discord.Client):
    ...
    def __init__(self):
        ...
        self.bot_data = BotDataManager('./intents.txt', './answers.txt')
    ...
    async def on_message(self, message):
        ...
        print(utterance)
        response = self.bot_data.answer(utterance)
